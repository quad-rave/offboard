...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rospy_template-msg:<Message> is deprecated: use rospy_template-msg:Message instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rospy_template-msg:value-val is deprecated.  Use rospy_template-msg:value instead.")
  (value m))
